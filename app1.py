...
app1.layout = html.Div(
    [
        html.Div(
            [
                # Navigation
                html.P("Welcome to the Stock Web-App!", className="start"),
                html.Div([
                    html.P("Input stock token: "),
                    html.Div([
...
@app1.callback([Output("main-content", "children")], [
...
@app1.callback([Output("forecast-content", "children")],
